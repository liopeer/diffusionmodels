...
def run():
    config = None
    with open("config_lyricfirebrand8.json", "r") as f:
        config = json.load(f)
    ckp_num = 280
    ckpt_path = f"/itet-stor/peerli/net_scratch/lyric-firebrand-8/checkpoint{ckp_num}.pt"
    ...
    torchvision.utils.save_image(out, "samples_lyricfirebrand8.png")
